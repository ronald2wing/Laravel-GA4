...
class FacadeTest extends TestCase
{
    ...
    public function test_facade_can_be_used_in_blade_templates(): void
    {
        ...
        try {
            ...
            ob_end_clean();
            $this->fail('Failed to evaluate compiled Blade template: '.$e->getMessage());
        }
        $output = ob_get_clean();
    ...
    public function test_facade_methods_are_accessible(): void
    {
        ...
        // Also verify it returns a non-empty string with expected content
        $this->assertNotEmpty($script);
        $this->assertStringContainsString('G-TEST-METHODS', $script);
    }
