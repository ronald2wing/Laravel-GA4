...
class EdgeCaseTest extends TestCase
{
    ...
    /**
     * Test that measurement ID is properly HTML-escaped to prevent XSS attacks.
     *
    ...
    /**
     * Test that service handles various measurement ID formats correctly.
     *
     * @dataProvider measurementIdFormatsProvider
     */
    public function test_handles_various_measurement_id_formats(string $measurementId): void
    {
        ...
        if (! empty($script)) {
            ...
            // Without Livewire installed, send_page_view: false should NOT be present
